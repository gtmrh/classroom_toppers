...
import 'package:classroom_toppers/model/test_result_model/test_result_data.dart';
...
class _TestResultState extends State<TestResult> {
  TestResultData data = app.appController.testResultModel.data!;
  ...
  getData() async {
    //preapring data for tset solution view
    await app.appController.getAllTests();
    // await app.appController.checkTestSts(data.testId.toString());
        ...
        child: Column(
          children: [
            ...
            InkWell(
              onTap: () async {
                print(data.testId);
                print(app.appController.allTestList.isEmpty);

                AllTestData testData = app.appController.allTestList
                    .where((element) =>
                        element.id.toString() == data.testId.toString())
                    .toList()[0];

                print(
                    '${testData.testSeriesName}>>${testData.noOfQuestion}>>${testData.id}');
